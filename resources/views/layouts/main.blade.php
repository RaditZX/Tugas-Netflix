...
<div class="netflixLogo">
        <a id="logo" href="#home" style="font-weight: bold;">NITFLIX</a>
      </div>      
      <nav class="main-nav">       
  ...
  <body>
      ...
      <div class="container mt-4" style="display: flex;justify-content:center;align-item:center;">@yield('container')</div>
